...
module.exports = sequelize => {
  const attributes = {
    ...
    vision_third_flag: {
      ...
      primaryKey: false,
      autoIncrement: false,
      comment: "视力是否第三次测试：0-否 1-是",
      field: "vision_third_flag"
    },
    refract_third_flag: {
      type: DataTypes.INTEGER(10),
      allowNull: true,
      ...
      primaryKey: false,
      autoIncrement: false,
      comment: "屈光是否第三次测试：0-否 1-是",
      field: "refract_third_flag"
    },
    vision_device_name: {
      type: DataTypes.STRING(100),
      allowNull: true,
    ...
    naked_vision_left_err: {
      type: DataTypes.INTEGER(1),
      allowNull: true,
      defaultValue: "0",
      primaryKey: false,
      autoIncrement: false,
      comment: "左眼裸眼异常标识 0否1是",
      field: "naked_vision_left_err"
    },
    naked_vision_right_err: {
      type: DataTypes.INTEGER(1),
      allowNull: true,
      defaultValue: "0",
      primaryKey: false,
      autoIncrement: false,
      comment: "右眼裸眼异常标识 0否1是",
      field: "naked_vision_right_err"
    },
    cva_left_err: {
      type: DataTypes.INTEGER(1),
      allowNull: true,
  ...
  const options = {
    tableName: "t_spot_check_plan_info",
    comment: "",
    indexes: [{
      name: "idx_name",
      unique: false,
  ...
  const TSpotCheckPlanInfoModel = sequelize.define("t_spot_check_plan_info_model", attributes, options);
  return TSpotCheckPlanInfoModel;
};